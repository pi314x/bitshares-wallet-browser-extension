/*
 * Vendored from @noble/secp256k1 v2.3.0 (MIT, Paul Miller — https://github.com/paulmillr/noble-secp256k1)
 * Audited, zero-dependency, constant-time secp256k1. Do not edit by hand;
 * re-vendor from node_modules to update. Used for all SECRET-scalar ops
 * (key derivation, ECDSA signing, ECDH) so private keys are never handled
 * by the non-constant-time BigInt path in crypto-utils.js.
 */
