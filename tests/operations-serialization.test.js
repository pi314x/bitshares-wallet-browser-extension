...
function buildOps() {
  ...
  return {
    ...
    32:{fee,creator:A,owner:B,amount:amt(1000),policy:{type:0,begin_timestamp:ts,vesting_cliff_seconds:0,vesting_duration_seconds:31536000}},
    33:{fee,vesting_balance:'1.13.1',owner:A,amount:amt(1000)},
    34:{fee,owner:A,work_begin_date:ts,work_end_date:ts,daily_pay:100000,name:'worker1',url:'http://wk',initializer:{type:0}},
    35:{fee,payer:A,required_auths:[A],id:0,data:'0011'},
    36:{fee,fee_paying_account:A,predicates:[{type:0,account_id:A,name:'x'}],required_auths:[A]},
